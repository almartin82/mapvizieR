...
- exclude_prior_year_holdover:
  ...
  if, for instance, this year's 3rd grade includes students who were in
  the 3rd grade last year, drop their records from the data
...
- localization:
  ...
  controls goals and goal logic for report. See localization.R for more
  details
