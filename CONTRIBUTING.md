...
Thank you for considering contributing to mapvizieR! This document provides
...
duplicates. When you create a bug report, include as much detail as possible:

- **R version** and **package versions** (use `sessionInfo()`)
- **Operating system**
...
mapvizieR follows the [tidyverse style guide](https://style.tidyverse.org/) with
some adaptations:

- Use `snake_case` for function and variable names
- Use `camelCase` for mapvizieR-specific data column names (matching NWEA conventions)
...
- Include `@param`, `@return`, and `@examples` for all exported functions
...
Plot functions typically follow the pattern:
- `[name]_plot()` for standalone plots
- `[name]_table()` for table-format outputs
...
Contributors will be recognized in the package's `DESCRIPTION` file and in
release notes. Thank you for helping improve mapvizieR!
