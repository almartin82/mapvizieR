...
test_that("estimate_rit error conditions", {
  ...
  expect_error(
    estimate_rit(mapviz, studentid = 'F08000002', measurementscale = 'Mathematics',
                 target_date = '2013-10-20', method = 'logistic'), "method not available"
  )
  
  #bad student
  expect_error(
    estimate_rit(mapviz, studentid = 'abcdefg', measurementscale = 'Mathematics', 
                 target_date = '2013-10-20', method = 'closest'), "studentid not in mapvizieR cdf object"
  )
  
  #no measurementscale
  expect_error(
    estimate_rit(mapviz, studentid = 'F08000002', target_date = '2013-10-20', method = 'closest'), 
